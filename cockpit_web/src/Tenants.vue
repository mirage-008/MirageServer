      ...
      <table class="table w-full">
        <thead>
          <tr>
            ...
            <th class="hidden md:table-cell md:w-1/4">所有者</th>
            <th class="hidden md:table-cell w-1/4 lg:w-1/5">创建日期</th>
            <th class="hidden lg:table-cell md:flex-auto">最近连线</th>
